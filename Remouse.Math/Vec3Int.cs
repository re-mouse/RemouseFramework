...
namespace Remouse.Math
{
  ...
  public struct Vec3Int : IEquatable<Vec3Int>, IFormattable
  {
    ...
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)] get => (float)System.Math.Sqrt((float) (this.x * this.x + this.y * this.y + this.z * this.z));
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vec3Int Min(Vec3Int lhs, Vec3Int rhs) => new Vec3Int(System.Math.Min(lhs.x, rhs.x), System.Math.Min(lhs.y, rhs.y), System.Math.Min(lhs.z, rhs.z));
    ...
    /// <param name="rhs"></param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vec3Int Max(Vec3Int lhs, Vec3Int rhs) => new Vec3Int(System.Math.Max(lhs.x, rhs.x), System.Math.Max(lhs.y, rhs.y), System.Math.Max(lhs.z, rhs.z));
    ...
    public void Clamp(Vec3Int min, Vec3Int max)
    {
      ...
      this.z = System.Math.Max(min.z, this.z);
      this.z = System.Math.Min(max.z, this.z);
    }
