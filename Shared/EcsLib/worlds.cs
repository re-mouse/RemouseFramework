...
namespace Shared.EcsLib {
    ...
    public class EcsWorld {
        ...
        public void RaiseEntityChangeEvent<T>(int entity) {
            for (int ii = 0, iMax = _eventListeners.Count; ii < iMax; ii++) {
                _eventListeners[ii].OnEntityChanged(typeof(T), entity);
            }
        }
#endif
#if DEBUG && !LEOECSLITE_NO_SANITIZE_CHECKS
    ...
    public interface IEcsWorldEventListener {
        ...
        void OnEntityChanged (Type componentType, int entity);
