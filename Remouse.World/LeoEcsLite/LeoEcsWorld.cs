...
namespace Remouse.World
{
    internal class LeoEcsWorld : IWorld
    {
        ...
        private readonly List<IPostRunSystem> _postRunSystems = new List<IPostRunSystem>();
        
        public LeoEcsWorld(EcsWorld world, List<ISystem> systems)
        {
            _world = world;
        ...
        public T GetComponent<T>(int entityId) where T : struct, IComponent
        {
            ...
            return pool.Has(entityId) ? pool.Get(entityId) : default;
        }
