...
namespace Remouse.Database
{
    public static class DatabaseSerializer
    {
        ...
        private static void DeserializeItem(KeyValuePair<string, object> item, List<object> tableList, List<Settings> settingsList)
        {
        ...
        private static void DeserializeAndAddTable(KeyValuePair<string, object> item, List<object> tableList, Type type)
        {
            ...
            tableList.Add(deserializedTable);
        }
